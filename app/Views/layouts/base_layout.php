        ...
        <div class="container-fluid">
            <a class="navbar-brand fw-bold text-primary user-select-none py-0" href="<?= base_url() ?>">
                <div class="d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 600 600" version="1.1" class="me-2">
                ...
                <?php if (session()->has('_logged_user_id')) : ?>
                    <div class="dropdown text-end">
                        <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="<?= $loggedUser['user_image']; ?>" width="32" height="32" class="rounded-circle">
                            <span class="ms-2 fw-bold" style="font-size: smaller;"><?= $loggedUser['user_points']; ?></span>
                            <span class="fw-bold" style="font-size: smaller;">PTS</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end text-small">
                            <li>
                                <a class="dropdown-item" href="<?= base_url('user/' . $loggedUser['username']); ?>"><i class="bi bi-person-circle me-2"></i>View profile</a>
                            </li>
                            <li>
    ...
    <footer class="bg-black py-3 mt-auto">
        <div class="container">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                <li class="nav-item">
                    <a href="<?= base_url() ?>" class="nav-link px-2 text-white">Home</a>
                </li>
                <li class="nav-item">
