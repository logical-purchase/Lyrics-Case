...
<head>
    ...
    <title>Lyrics Case - log in</title>
            ...
            <div class="col-lg-4">
                <div class="bg-body rounded-3 shadow px-3 py-4">
                    <div class="d-flex align-items-center justify-content-center mb-4">
                        <span class="fs-5">Log into Lyrics Case</span>
                    </div>
                    <form action="<?= base_url('check'); ?>" method="post" autocomplete="off">
                        ...
                        <button class="btn btn-primary fw-medium mt-3 w-100" type="submit">Log in</button>

                        <div class="d-flex justify-content-center mt-4">
                            <a href="#" class="link-underline link-underline-opacity-0 link-underline-opacity-100-hover">Forgot password?</a>
                            <span class="text-primary mx-2">·</span>
                            <a href="<?= base_url('signup'); ?>" class="link-underline link-underline-opacity-0 link-underline-opacity-100-hover">Create new account</a>
                        </div>
                    </form>
                </div>
            </div>
